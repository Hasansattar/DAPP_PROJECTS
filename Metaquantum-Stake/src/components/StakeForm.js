          ...
          if (account) {
            const _staking_Balance =
              plan.plan == 0
                ...
                : plan.plan == 1
                ? blockChainData.StakedBalance1
                : plan.plan == 2
                ? blockChainData.StakedBalance2
                : 0;
      ...
      <div>
        ...
        <div className="w-full flex items-center justify-between">
          <div className="w-3/4 relative">
            ...
            />{" "}
            <span
              className="absolute top-0 right-0 mr-3 mt-1 cursor-pointer hover:text-yellow-500"
            ...
            <>
              <button
                className={classNames(
                  "bg-purple-900 text-white rounded-full border border-white uppercase px-4 py-2 ml-4 text-sm font-bold hover:text-purple-400 min-w-[125px]",
                  {
                    hidden: approve,
                  }
                )}
      ...
      <div className="mt-2">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          {isLoading && Withdraw ? (
            ...
            <button
              className="bg-purple-900 font-bold uppercase text-[color:var(--font-color)] px-4 py-2 ml-4 text-sm hover:text-purple-400 rounded-full border border-white min-w-[125px]"
