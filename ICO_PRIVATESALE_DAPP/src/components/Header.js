...
import {TOKEN_CONTRACT,TOKEN_DECIMAL,NETWORK_ID,BLOCKCHAIN_EXPLORER} from "./../abi/config.js";
    ...
    <div className="w-full flex items-center flex-col">
      ...
      <div className="mt-4 sm:mt-0">
        ...
        {account ? (
          ...
          <button
            className="px-6 py-2 bg-[#ab5c2a] hover:bg-yellow-300 rounded text-black font-bold"
