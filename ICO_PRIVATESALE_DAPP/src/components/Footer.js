    ...
    <footer className="text-gray-600 body-font mt-3 w-full ">
      <div className="bg-black bg-opacity-40">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row justify-between">
          <p className="text-[#ab5c2a] text-sm text-center sm:text-left">
            {" "}
            ©{new Date().getFullYear()}
            METTA PROTOCOL
          </p>{" "}
          <span className="inline-flex sm:mt-0 mt-2 justify-center sm:justify-start">
            <a className="text-[#ab5c2a]">
              <svg
                fill="currentColor"
                strokeLinecap="round"
          ...
          <p className="text-[#ab5c2a] text-xs text-center sm:text-left mt-2 sm:mt-0">
            {" "}
            Powered by: & nbsp;{" "}
