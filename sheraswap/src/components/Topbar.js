...
function Topbar() {
  ...
  return (
    <div className="w-full min-h-[50px] px-5 pt-5 sticky top-0 ">
      <button
        className="text-white text-xs flex flex-row items-center justify-between px-4 py-1 rounded-lg border hover:bg-white hover:bg-opacity-25 ease-in duration-200 hover:shadow-md hover:shadow-white "
        onClick={() => addToken()}
      >
