    ...
    return ( <div className = "flex items-center flex-col w-full" >
        ...
        alt = "Shera tokens" />
            ...
            blockchainData && ( <div >
                ...
                <p className = 'text-center text-xl' > Shera Old Token Balance: {
                    blockchainData.tbalance
                }
                SHR </p> <div className = 'flex justify-between items-center flex-col' >
                <button disabled = {
                    (parseInt(blockchainData.tbalance) === 0 || loading === true)
                }
                className = "btn-grad mt-4 px-8 py-1"
                onClick = {
                    () => swap()
        ...
        <div className = "max-w-xs mx-auto" > {
            account ? ( <button className = "btn-grad px-4 py-3"
                onClick = {
                    () => disconnectWallet()
                } > Disconnect </button>
            ) : ( <button className = "btn-grad px-4 py-3"
                onClick = {
                    () => connectWallet()
